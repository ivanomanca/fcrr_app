 ...
 */
public class CartagoContextRemote extends UnicastRemoteObject implements ICartagoContextRemote {
    
    public CartagoContext ctx;  
	private long lastPingFromMind;
	
    
        /** Creates a new instance of CartagoRemoteContext */
    public CartagoContextRemote() throws SecurityException, RemoteException  {
        super();  
    }
    
    public CartagoContextRemote(CartagoContext ctx) throws SecurityException, RemoteException  {
        super();  
        this.ctx = ctx;
