 ...
 * {@link TabActivity} linked to a specialisation of a CArtAgO {@link GUIArtifact}
 * @author mguidi
 *
 */
public class JaCaTabActivity extends TabActivity implements IJaCaActivity {
	...
	/**
	 * Run JaCaService if not already running
	 * 
	 ...
	 * started the JaCaService using the {@link runJaCaService} 
	 * method.
