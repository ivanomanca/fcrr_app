...
/**
 * Developers must extend this class to define a standard Android
 * {@link ListActivity} linked to a specialisation of a CArtAgO {@link GUIArtifact}
 * @author mguidi
 *
 */
public class JaCaListActivity extends ListActivity implements IJaCaActivity {
	...
	/**
	 * Stop a running JaCaService, and the MAS it wraps  
	 */
	...
	/** Specific method for the {@link ListActvitity} **/
	@Override
	protected void onListItemClick(ListView l, View v, int position, long id) {
		mActivityEventFetcher.putEvent(new EventOpInfo(this, ActivityEventsFetcher.ON_LIST_ITEM_CLICK, l, v, position, id));
	}
	...
	/**
	 * Create the specialisation of the GUIArtifact wrapping this JaCaActivity. 
	...
	/**
	 * Dispose the specialisation of the GUIArtifact wrapping this JaCaActivity.
	 */
