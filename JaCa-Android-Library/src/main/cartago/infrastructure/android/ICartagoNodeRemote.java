...
public interface ICartagoNodeRemote extends IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements ICartagoNodeRemote {
		private static final java.lang.String DESCRIPTOR = "cartago.infrastructure.android.ICartagoNodeRemote";
		 ...
		 */
		public static ICartagoNodeRemote asInterface(android.os.IBinder obj) {
			if ((obj==null)) {
				return null;
			}
			...
			return new ICartagoNodeRemote.Stub.Proxy(obj);
		}
